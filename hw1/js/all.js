...
function getData(offset, limit, zone) {
    var result;
    $.ajax({
...
function addAdministrativeZoneBtnListener() {
...
function initRecords() {
    var data = getData(offset, limit, zone);
...
addAdministrativeZoneBtnListener();
